-- Fix composite primary keys: Doctrine generates id INTEGER PRIMARY KEY AUTOINCREMENT
-- for these three tables, but the correct schema is PRIMARY KEY (id, version).
-- DROP and recreate with composite PK before inserting seed data.

DROP TABLE IF EXISTS ezcontentclass;
CREATE TABLE ezcontentclass (id INTEGER NOT NULL, version INTEGER DEFAULT 0 NOT NULL, always_available INTEGER DEFAULT 0 NOT NULL, contentobject_name VARCHAR(255) DEFAULT NULL, created INTEGER DEFAULT 0 NOT NULL, creator_id INTEGER DEFAULT 0 NOT NULL, identifier VARCHAR(50) DEFAULT '' NOT NULL, initial_language_id BIGINT DEFAULT 0 NOT NULL, is_container INTEGER DEFAULT 0 NOT NULL, language_mask BIGINT DEFAULT 0 NOT NULL, modified INTEGER DEFAULT 0 NOT NULL, modifier_id INTEGER DEFAULT 0 NOT NULL, remote_id VARCHAR(100) DEFAULT '' NOT NULL, serialized_description_list CLOB DEFAULT NULL, serialized_name_list CLOB DEFAULT NULL, sort_field INTEGER DEFAULT 1 NOT NULL, sort_order INTEGER DEFAULT 1 NOT NULL, url_alias_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id, version));
...
VALUES (1,'',2,0,0,0,0,255,0,0,0,'New article','','','','','ezstring',1,'title',0,1,1,1,0,NULL,NULL,'a:2:{s:6:"eng-GB";s:5:"Title";s:16:"always-available";s:6:"eng-GB";}',0),
       ...
       (1,'',3,0,0,0,0,255,0,0,0,'','','','',NULL,'ezstring',7,'description',0,0,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:11:"Description";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',4,0,0,0,0,255,0,0,0,'','','','','','ezstring',8,'first_name',0,1,1,0,1,NULL,NULL,'a:2:{s:6:"eng-GB";s:10:"First name";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',4,0,0,0,0,255,0,0,0,'','','','','','ezstring',9,'last_name',0,1,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:9:"Last name";s:16:"always-available";s:6:"eng-GB";}',0),
       ...
       (1,'',5,10.0,0,0,0,0,0,0,0,'MB','','','',NULL,'ezimage',118,'image',0,0,1,1,3,NULL,NULL,'a:2:{s:6:"eng-GB";s:5:"Image";s:16:"always-available";s:6:"eng-GB";}',0),
       ...
       (0,'',2,0,0,0,0,0,0,0,0,'','','','','','ezboolean',123,'enable_comments',0,0,0,0,6,NULL,NULL,'a:2:{s:6:"eng-GB";s:15:"Enable comments";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',12,0,0,0,0,0,0,0,0,'New file','','','',NULL,'ezstring',146,'name',0,1,1,0,1,NULL,NULL,'a:2:{s:6:"eng-GB";s:4:"Name";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',12,0,0,0,0,10,0,0,0,'','','','',NULL,'ezrichtext',147,'description',0,0,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:11:"Description";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',12,0,0,0,0,0,0,0,0,'','','','',NULL,'ezbinaryfile',148,'file',0,1,0,0,3,NULL,NULL,'a:2:{s:6:"eng-GB";s:4:"File";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',2,0,0,0,0,255,0,0,0,'','','','','','ezstring',152,'short_title',0,0,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:11:"Short title";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',2,0,0,0,0,1,0,0,0,'','','','','','ezauthor',153,'author',0,0,0,0,3,NULL,NULL,'a:2:{s:6:"eng-GB";s:6:"Author";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',2,0,0,0,0,0,0,0,0,'','','','','','ezobjectrelation',154,'image',0,0,1,0,7,NULL,NULL,'a:2:{s:6:"eng-GB";s:5:"Image";s:16:"always-available";s:6:"eng-GB";}',0),
