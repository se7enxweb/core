...
VALUES (1,'',2,0,0,0,0,255,0,0,0,'New article','','','','','ibexa_string',1,'title',0,1,1,1,0,NULL,NULL,'a:2:{s:6:"eng-GB";s:5:"Title";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',1,NULL,NULL,NULL,NULL,255,0,NULL,NULL,'Folder',NULL,NULL,NULL,NULL,'ibexa_string',4,'name',0,1,1,0,1,'N;','a:0:{}','a:1:{s:6:"eng-GB";s:4:"Name";}',0),
       (1,'',3,0,0,0,0,255,0,0,0,'','','','',NULL,'ibexa_string',6,'name',0,1,1,0,1,NULL,NULL,'a:2:{s:6:"eng-GB";s:4:"Name";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',3,0,0,0,0,255,0,0,0,'','','','',NULL,'ibexa_string',7,'description',0,0,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:11:"Description";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',4,0,0,0,0,255,0,0,0,'','','','','','ibexa_string',8,'first_name',0,1,1,0,1,NULL,NULL,'a:2:{s:6:"eng-GB";s:10:"First name";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',4,0,0,0,0,255,0,0,0,'','','','','','ibexa_string',9,'last_name',0,1,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:9:"Last name";s:16:"always-available";s:6:"eng-GB";}',0),
       (0,'',4,0,0,0,0,7,10,0,0,'','^[^@]+$','','','','ibexa_user',12,'user_account',0,1,0,0,3,NULL,NULL,'a:2:{s:6:"eng-GB";s:12:"User account";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',5,0,0,0,0,150,0,0,0,'','','','',NULL,'ibexa_string',116,'name',0,1,1,0,1,NULL,NULL,'a:2:{s:6:"eng-GB";s:4:"Name";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',5,0,0,0,0,10,0,0,0,'','','','',NULL,'ibexa_richtext',117,'caption',0,0,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:7:"Caption";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',5,10.0,0,0,0,0,0,0,0,'MB','','','',NULL,'ibexa_image',118,'image',0,0,1,1,3,NULL,NULL,'a:2:{s:6:"eng-GB";s:5:"Image";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',1,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'ibexa_richtext',119,'short_description',0,0,1,0,3,'N;','a:0:{}','a:1:{s:6:"eng-GB";s:17:"Short description";}',0),
       (1,'',2,0,0,0,0,10,0,0,0,'','','','','','ibexa_richtext',120,'intro',0,1,1,0,4,NULL,NULL,'a:2:{s:6:"eng-GB";s:5:"Intro";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',2,0,0,0,0,20,0,0,0,'','','','','','ibexa_richtext',121,'body',0,0,1,0,5,NULL,NULL,'a:2:{s:6:"eng-GB";s:4:"Body";s:16:"always-available";s:6:"eng-GB";}',0),
       (0,'',2,0,0,0,0,0,0,0,0,'','','','','','ibexa_boolean',123,'enable_comments',0,0,0,0,6,NULL,NULL,'a:2:{s:6:"eng-GB";s:15:"Enable comments";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',12,0,0,0,0,0,0,0,0,'New file','','','',NULL,'ibexa_string',146,'name',0,1,1,0,1,NULL,NULL,'a:2:{s:6:"eng-GB";s:4:"Name";s:16:"always-available";s:6:"eng-GB";}',0),
       (1,'',12,0,0,0,0,10,0,0,0,'','','','',NULL,'ibexa_richtext',147,'description',0,0,1,0,2,NULL,NULL,'a:2:{s:6:"eng-GB";s:11:"Description";s:16:"always-available";s:6:"eng-GB";}',0),
       ...
       (1,'',4,10.0,0,0,0,0,0,0,0,'MB','','','','','ibexa_image',180,'image',0,0,0,1,5,NULL,NULL,'a:2:{s:6:"eng-GB";s:5:"Image";s:16:"always-available";s:6:"eng-GB";}',0);
...
VALUES (0,4,1,NULL,NULL,'Exponential Platform','ibexa_string',1,'eng-GB',3,0,'ibexa platform',9),
       ...
       (0,119,41,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',99,'eng-GB',3,0,'',1),
       ...
       (0,155,1,NULL,NULL,'Exponential Platform','ibexa_string',102,'eng-GB',3,0,'ibexa platform',9),
       (0,155,41,0,0,'','ibexa_string',103,'eng-GB',3,0,'',1),
       (0,156,1,NULL,NULL,'<?xml version="1.0" encoding="UTF-8"?><section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"><para>This is the clean installation coming with Exponential Platform.</para><para>It''s a bare-bones setup of the Platform, an excellent foundation to build upon if you want to start your project from scratch.</para></section>','ibexa_richtext',104,'eng-GB',3,0,'',9),
       (0,156,41,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',105,'eng-GB',3,0,'',1),
       (0,4,49,0,0,'Images','ibexa_string',142,'eng-GB',3,0,'images',1),
       (0,155,49,0,0,'','ibexa_string',143,'eng-GB',3,0,'',1),
       (0,119,49,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',144,'eng-GB',3,0,'',1),
       (0,156,49,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',145,'eng-GB',3,0,'',1),
       (0,4,50,0,0,'Files','ibexa_string',147,'eng-GB',3,0,'files',1),
       (0,155,50,0,0,'','ibexa_string',148,'eng-GB',3,0,'',1),
       (0,119,50,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',149,'eng-GB',3,0,'',1),
       (0,156,50,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',150,'eng-GB',3,0,'',1),
       (0,4,51,0,0,'Multimedia','ibexa_string',152,'eng-GB',3,0,'multimedia',1),
       (0,155,51,0,0,'','ibexa_string',153,'eng-GB',3,0,'',1),
       (0,119,51,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',154,'eng-GB',3,0,'',1),
       (0,156,51,0,1045487555,'<?xml version="1.0" encoding="UTF-8"?> <section xmlns="http://docbook.org/ns/docbook" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ezxhtml="http://ibexa.co/xmlns/dxp/docbook/xhtml" xmlns:ezcustom="http://ibexa.co/xmlns/dxp/docbook/custom" version="5.0-variant ezpublish-1.0"/> ','ibexa_richtext',155,'eng-GB',3,0,'',1),
       ...
       (0,180,14,0,0,'<?xml version="1.0" encoding="utf-8"?> <ezimage serial_number="1" is_valid="" filename="" suffix="" basename="" dirpath="" url="" original_filename="" mime_type="" width="" height="" alternative_text="" alias_key="1293033771" timestamp="1301057722"><original attribute_id="180" attribute_version="3" attribute_language="eng-GB"/></ezimage> ','ibexa_image',180,'eng-GB',3,0,'',3);
